...
NAME = 'CathayRestore'
ENTRY = 'gui.py'
EXTRA = ['--collect-all', 'tkinterdnd2', '--hidden-import', 'fitz']
REPO = 'https://github.com/zzhjim02/CathayRestore'
...
- `CathayRestore.exe` —— 单文件版，约 %.0f MB，双击即用
- `runtime\\`（约 89 MB，自带 Python）+ `写回.bat`
